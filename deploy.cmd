...
%MSBUILD_PATH% "%DEPLOYMENT_SOURCE%\MvcApplicationEF\MvcApplicationEF.csproj" /nologo /verbosity:m /t:Build /t:pipelinePreDeployCopyAllFilesToOneFolder /p:_PackageTempDir="%DEPLOYMENT_TEMP%";AutoParameterizationWebConfigConnectionStrings=false;Configuration=Release /p:SolutionDir="%DEPLOYMENT_SOURCE%\."
IF !ERRORLEVEL! NEQ 0 goto error
